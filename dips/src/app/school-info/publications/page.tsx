...
export default function Page() {
  return (
    ...
    >
      <p>The school publishes an annual magazine, newsletters, and student journals showcasing the creative work of students across all grades. These publications celebrate academic and creative excellence.</p></InnerPage>
  );
}
