...
export default function Page() {
  return (
    ...
    >
      <p>The safety and security of our students is our top priority. DIPS has CCTV surveillance throughout the campus, trained security personnel, and a strict visitor management system.</p></InnerPage>
  );
}
