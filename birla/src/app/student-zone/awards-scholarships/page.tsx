...
import { AccordionItem, BatchTable, PdfEmbed, useAccordion } from "@/utils/Accordion";
...
const SUPW_HEADERS = ["S.No.", "Name of Student", "Class/Sec", "Sch.No", "House"];
          ...
          <div className="col-12 col-lg-8">
            <div className="inner-content">
              <div className="contentsection noborder">
                <div className="accordion accordion-flush" id="accordionAwards">

                  <AccordionItem id="supw" label="Annual SUPW Award List" openId={openId} setOpenId={setOpenId}>
                    <BatchTable heading="Dance" colSpan={5} headers={SUPW_HEADERS} rows={[
                    ...
                    <BatchTable heading="Tabla" colSpan={5} headers={SUPW_HEADERS} rows={[
                    ...
                    <BatchTable heading="Vocal Music" colSpan={5} headers={SUPW_HEADERS} rows={[
                    ...
                    <BatchTable heading="Art" colSpan={5} headers={SUPW_HEADERS} rows={[
                      ...
                      ["5","Swastik Sajwan","VIII-G","9665","Aravali"],
                      ["6","Vani Beswal","VIII-H","9992","Kailash"],
                    ...
                    <BatchTable heading="Collage & Paper Craft" colSpan={5} headers={SUPW_HEADERS} rows={[
                      ["1","Jagrav Rampal","VI-B","11059","Nilgiri"],
                      ["2","Shivika Mewati","VI-D","11153","Nilgiri"],
                      ["3","Kaavya Behl","VII-B","10329","Nilgiri"],
                      ["4","Abhiyansh Singh","VII-A","10370","Vindhya"],
                    ...
                    <BatchTable heading="Photography" colSpan={5} headers={SUPW_HEADERS} rows={[
                      ["1","Tushar Mahajan","XI-D","8632","Aravali"],
                      ["2","Devv Khemani","VII-F","10283","Vindhya"],
                    ]} />
                    <BatchTable heading="Western Music" colSpan={5} headers={SUPW_HEADERS} rows={[
                  ...
                  <AccordionItem id="pdf" label="Scholars 2018-2019 Class VI (90% And Above)" openId={openId} setOpenId={setOpenId}>
                    <PdfEmbed src="/documents/scholars-2018-2019.pdf" title="Scholars 2018-2019" />
                  </AccordionItem>
