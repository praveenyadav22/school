    ...
    <div className="column_alignment base_margin">
      ...
      <div className="column_alignment section_wrapper">
        <div className="main_content about_content_wrapper align_self_center">
          ...
          {[
            { title: '1. Admission', text: 'Admission to SCPS is subject to availability of seats and fulfillment of eligibility criteria as specified by the school from time to time. The school reserves the right to accept or reject any application without providing reasons.' },
            ...
            { title: '5. Communication', text: 'Parents are expected to keep their contact information updated with the school at all times. Important communications are sent via the school\'s official channels including SMS, email, and the school app.' },
            ...
            <div key={section.title} style={{ marginTop: 24 }}>
              <h3 style={{ color: 'var(--colorAccent)', margin: '0 0 8px' }}>{section.title}</h3>
              <p style={{ margin: 0, lineHeight: 1.7, color: '#555' }}>{section.text}</p>
            </div>
          ))}
